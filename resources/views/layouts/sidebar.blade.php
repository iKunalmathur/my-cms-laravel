...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200 flex" href="#">
        ...
        <ul class="mt-6">
                ...
                {{-- <template x-if="isPagesMenuOpen"> --}}
                    <template x-if="true">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                @if (url()->current() == url('/post_categories'))
                                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                                    aria-hidden="true"></span>
                                @endif
            ...
            <li class="relative px-6 py-3">
                @if (url()->current() == url('/advertisements'))
                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold text-gray-500 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-400"
            ...
            <li class="relative px-6 py-3">
                @if (url()->current() == url('/subscribers'))
                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold text-gray-500 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-400"
                    ...
                    <span class="ml-4">Subscriber</span>
                </a>
            </li>
        </ul>
        <ul>
